...
// Bloqueia /dashboard/conversas (e /dashboard/conversas/fluxo/**) pra contas
// sem o serviço "whatsapp" contratado — além de escondido no menu
// (DashboardShell), pra quem tentar acessar a URL direto. Admin de
// plataforma vê tudo, a não ser que tenha ligado "Ver como cliente" (mesmo
// padrão do gate de conexão do WhatsApp em DashboardShell).
